...
4. **Windows fleets:** this repository supports native Windows 11 through the vendored
   `agy-headless-bridge` v1.2.1 source + ConPTY. Standardize Python 3.9+, pywinpty, and agy
